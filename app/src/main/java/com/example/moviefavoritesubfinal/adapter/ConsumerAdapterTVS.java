...
public class ConsumerAdapterTVS extends RecyclerView.Adapter<ConsumerAdapterTVS.NoteViewHolder> {

    private final ArrayList<TVShow> listMovies = new ArrayList<>();
    ...
    public ConsumerAdapterTVS(Activity activity) {
    ...
    public void setListNotes(ArrayList<TVShow> listNotes) {
